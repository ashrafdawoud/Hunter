...
import com.indrul.hunter.Utils.CardUtils;
    ...
    public void connectApi(Context context){
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(@NotNull Call call, @NotNull IOException e) {
                Log.e("newcallhttpcart22",e.getMessage());
                connectApi(context);
            }
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                if (response.isSuccessful ( )) {
                    ...
                    Log.e("newcallhttpcart22",respons);
                    cardModel=CardUtils.jsonparsing(respons);
                    cardModelMutableLiveData.postValue(cardModel);
                }
            }
        });
    }
